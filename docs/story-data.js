...
// For markers that share a location, we use displayLat/displayLng
// to offset the marker visually, and a leader line connects back
// to the real lat/lng.
...
const STORY_DATA = [
  {
    ...
    title: {
      en: "Birth in Schneidemühl",
      de: "Geburt in Schneidemühl"
    },
    location: {
...
<p>Beate Zülsdorf kam einen Monat zu früh im Krankenhaus in <span class="placename" data-old="Schneidemühl" data-new="Piła, Polen">Schneidemühl</span> zur Welt. Ihr Vater neckte ihre Mutter gutmütig wegen Beates schwarzem Haar. Nach einigen Monaten wurden ihre goldenen Locken in der ganzen Kindheit bewundert. Sie entwickelte sich zu einem gesunden und fröhlichen kleinen Mädchen, das Ebenbild ihres Vaters.</p>`
    }
  },
  {
    id: 2,
    ...
    lat: 53.22,
    lng: 16.60,
    // Offset display position so it doesn't overlap with #3
    displayLat: 53.32,
    displayLng: 16.42,
    body: {
      en: `<p>Beate's father, Maximilian Augustin Zülsdorf, managed an 80-hectare (200-acre) farming estate in <span class="placename" data-old="Breitenstein" data-new="near Piła, Poland">Breitenstein</span>, West Prussia. The farmyard was encircled by the farmhouse, horse and cow stables, barns for hay, straw, and grain, and barns for small animals. Beate played happily with all the baby animals: kids, lambs, piglets, calves, colts, and all her feathered friends.</p>
...
<p>The Polish family Purmann — Mr. and Mrs. Purmann and their four children — were assigned to the farm as laborers. They were decent, hard-working people who became helping hands as well as friends, and would save the Zülsdorf family's lives more than once during the coming evacuation.</p>`,
      de: `<p>Beates Vater, Maximilian Augustin Zülsdorf, bewirtschaftete ein 80 Hektar großes Gut in <span class="placename" data-old="Breitenstein" data-new="bei Piła, Polen">Breitenstein</span>, Westpreußen. Der Hof war umgeben vom Bauernhaus, Pferde- und Kuhställen, Scheunen für Heu, Stroh und Getreide, und Ställen für Kleintiere. Beate spielte fröhlich mit allen Tierbabys: Zicklein, Lämmern, Ferkeln, Kälbern, Fohlen und all ihren gefiederten Freunden.</p>
...
<p>Die polnische Familie Purmann — Herr und Frau Purmann mit ihren vier Kindern — wurden dem Hof als Arbeitskräfte zugeteilt. Sie waren anständige, fleißige Menschen, die zu helfenden Händen und Freunden wurden und der Familie Zülsdorf während der kommenden Evakuierung mehr als einmal das Leben retten sollten.</p>`
  ...
  },
  {
    ...
    lat: 53.22,
    lng: 16.60,
    // Offset opposite direction from #2
    displayLat: 53.12,
    displayLng: 16.78,
    body: {
...
<p>Es war das letzte Mal, dass sie ihn sahen. Maximilian Zülsdorf wurde als vermisst gemeldet und trotz jahrelanger Suche über das Rote Kreuz nie gefunden.</p>`
  ...
  },
  {
    ...
    lat: 53.80,
    lng: 13.10,
    // Offset NW from Moltzahn cluster
    displayLat: 53.98,
    displayLng: 12.80,
    body: {
      en: `<p>In February 1945, with the Russians advancing throughout Prussia, the family was evacuated by horse-drawn covered wagon train from West Prussia to <span class="placename" data-old="Mecklenburg" data-new="Mecklenburg-Vorpommern, Germany">Mecklenburg</span>. It was an approximately 200-mile westward journey under treacherous conditions through ice and snow in the depth of winter.</p>
...
<p>They lost one mare, Lotte, due to a broken leg on the ice. Along the way, they found Beate's brother Georg convalescing in a military hospital in <span class="placename" data-old="Märkisch Friedland" data-new="Mirosławiec, Poland">Märkisch Friedland</span> with a severe leg injury. He escaped the hospital and was hidden in the rear of their wagon, as German military patrols searched for deserters.</p>
<p>They reached <span class="placename" data-old="Moltzahn" data-new="Moltzahn, Mecklenburg-Vorpommern">Moltzahn</span>, in the district of <span class="placename" data-old="Demmin" data-new="Demmin, Mecklenburg-Vorpommern">Demmin</span>, Mecklenburg, in March 1945.</p>`,
      de: `<p>Im Februar 1945, als die Russen durch ganz Preußen vorrückten, wurde die Familie mit Pferdewagen aus Westpreußen nach <span class="placename" data-old="Mecklenburg" data-new="Mecklenburg-Vorpommern, Deutschland">Mecklenburg</span> evakuiert. Es war eine etwa 320 Kilometer lange Reise nach Westen unter gefährlichen Bedingungen durch Eis und Schnee im tiefsten Winter.</p>
...
<p>Sie verloren eine Stute, Lotte, wegen eines Beinbruchs auf dem Eis. Unterwegs fanden sie Beates Bruder Georg, der in einem Militärkrankenhaus in <span class="placename" data-old="Märkisch Friedland" data-new="Mirosławiec, Polen">Märkisch Friedland</span> mit einer schweren Beinverletzung lag. Er floh aus dem Krankenhaus und wurde hinten im Wagen versteckt, da deutsche Militärpatrouillen nach Deserteuren suchten.</p>
<p>Im März 1945 erreichten sie <span class="placename" data-old="Moltzahn" data-new="Moltzahn, Mecklenburg-Vorpommern">Moltzahn</span> im Kreis <span class="placename" data-old="Demmin" data-new="Demmin, Mecklenburg-Vorpommern">Demmin</span>, Mecklenburg.</p>`
    }
  },
  {
    id: 5,
    ...
    location: {
      en: "Moltzahn, Mecklenburg-Vorpommern, Germany",
      de: "Moltzahn, Mecklenburg-Vorpommern, Deutschland"
    },
    lat: 53.88,
    lng: 13.07,
    body: {
      en: `<p>By the end of March, the Russians advanced deep into their Baltic region in <span class="placename" data-old="Mecklenburg" data-new="Mecklenburg-Vorpommern, Germany">Mecklenburg</span>. From then on, Florian and Leo had the dangerous task of hiding Georg every night in a different place — attics, cellars, haylofts, feeding troughs, and haystacks in the open fields.</p>
...
<p>May 8, 1945 brought the end of WWII and the biggest joy was seeing Georg again safely.</p>`,
      de: `<p>Ende März rückten die Russen tief in ihre baltische Region in <span class="placename" data-old="Mecklenburg" data-new="Mecklenburg-Vorpommern, Deutschland">Mecklenburg</span> vor. Von da an hatten Florian und Leo die gefährliche Aufgabe, Georg jede Nacht an einem anderen Ort zu verstecken — in Dachböden, Kellern, Heuböden, Futtertrögen und Heuhaufen auf offenen Feldern.</p>
...
<p>Der 8. Mai 1945 brachte das Ende des Zweiten Weltkriegs und die größte Freude war es, Georg wieder sicher zu sehen.</p>`
  ...
  },
  {
    ...
    displayLng: 13.32,
    body: {
      en: `<p>In autumn 1945, the family was moved into the schoolhouse of <span class="placename" data-old="Moltzahn" data-new="Moltzahn, Mecklenburg-Vorpommern">Moltzahn</span>. Beate's mother, grandfather Opa Paul, brother Georg, and Beate shared one room downstairs. The kitchen and toilets were shared among three families and a schoolteacher.</p>
...
<p>In August 1948, Beate's beloved Opa Paul passed away at age 84. She was inconsolable.</p>`,
      de: `<p>Im Herbst 1945 wurde die Familie in das Schulhaus von <span class="placename" data-old="Moltzahn" data-new="Moltzahn, Mecklenburg-Vorpommern">Moltzahn</span> umgesiedelt. Beates Mutter, Großvater Opa Paul, Bruder Georg und Beate teilten sich ein Zimmer im Erdgeschoss. Die Küche und Toiletten wurden von drei Familien und einer Lehrerin geteilt.</p>
...
<p>Im August 1948 verstarb Beates geliebter Opa Paul im Alter von 84 Jahren. Sie war untröstlich.</p>`
  ...
  },
  {
    ...
    location: {
      en: "Buschmühl, near Demmin, Mecklenburg-Vorpommern, Germany",
      de: "Buschmühl, bei Demmin, Mecklenburg-Vorpommern, Deutschland"
    },
    lat: 53.87,
    lng: 13.12,
    // Offset NE from Moltzahn cluster
    displayLat: 53.97,
    displayLng: 13.40,
    body: {
      en: `<p>Georg married Grete, and they leased a farm in <span class="placename" data-old="Buschmühl" data-new="near Demmin, Mecklenburg-Vorpommern">Buschmühl</span>, 7 km from <span class="placename" data-old="Demmin" data-new="Demmin, Mecklenburg-Vorpommern">Demmin</span>. Beate and her mother moved with them. Life was filled with hard work: feeding animals, milking cows and the goat, cleaning stalls, plowing with Borina, sowing grain, and harvesting. By age ten, Beate could identify all the different grain sprouts.</p>
...
<p>Between 1948 and 1952, all farmland was confiscated by the Communist government and only leased to farmers. Each farmer had an impossible quota of produce to meet. Georg held on as long as he could, but after four years, could no longer meet the required quota. The farm was auctioned off. They sold Borina — their last treasure from their homeland. "The memory of that evening still brings tears to my eyes."</p>`,
      de: `<p>Georg heiratete Grete, und sie pachteten einen Bauernhof in <span class="placename" data-old="Buschmühl" data-new="bei Demmin, Mecklenburg-Vorpommern">Buschmühl</span>, 7 km von <span class="placename" data-old="Demmin" data-new="Demmin, Mecklenburg-Vorpommern">Demmin</span>. Beate und ihre Mutter zogen mit. Das Leben war voller harter Arbeit: Tiere füttern, Kühe und die Ziege melken, Ställe ausmisten, mit Borina pflügen, Getreide säen und ernten. Mit zehn Jahren konnte Beate alle verschiedenen Getreidekeimlinge unterscheiden.</p>
...
<p>After three days they received passports and traveled to <span class="placename" data-old="Pirmasens" data-new="Pirmasens, Rhineland-Palatinate">Pirmasens</span> in the <span class="placename" data-old="Pfalz" data-new="Rhineland-Palatinate, Germany">Pfalz</span>, where the mayor, Mr. Ried — a former military officer who had been stationed on their farm — was their sponsor. But he was on vacation. They were housed in a sweltering attic room and served meals in the servants' area.</p>
<p>Driven to the village of <span class="placename" data-old="Schweix" data-new="Schweix, Rhineland-Palatinate">Schweix</span> near the French border, they found their apartment was not yet ready. Unable to afford to wait, they made the difficult decision to return to East Germany. At the border, 12-year-old Beate had East German money sewn under her Young Pioneer uniform emblem. When the patrol asked if she was a Young Pioneer leader, her quivering "Yes" got them through.</p>`,
...
<p>This time Mr. Ried greeted them personally. They dined in the lavish dining room and were given the proper guest room. Their apartment in <span class="placename" data-old="Schweix" data-new="Schweix, Rhineland-Palatinate">Schweix</span> — two rooms, kitchen, and foyer — was ready. They moved in on December 18 with just two suitcases and a trunk.</p>
...
<p>Diesmal begrüßte Herr Ried sie persönlich. Sie speisten im prachtvollen Esszimmer und bekamen das richtige Gästezimmer. Ihre Wohnung in <span class="placename" data-old="Schweix" data-new="Schweix, Rheinland-Pfalz">Schweix</span> — zwei Zimmer, Küche und Flur — war fertig. Am 18. Dezember zogen sie mit nur zwei Koffern und einem Überseekoffer ein.</p>
...
<p>Sie zogen in eine große Wohnung auf Manhattans Westseite, 72. Straße und Riverside Park, 11. Stock, mit Blick auf den Hudson River, die George Washington Bridge und den New Yorker Hafen.</p>`
  ...
  },
  {
    ...
    lat: 40.641,
    lng: -73.778,
    // Offset south so it doesn't overlap with #13
    displayLat: 40.52,
    displayLng: -73.65,
    body: {
...
<p>Training was six weeks of intensive instruction on grooming, service, emergency procedures, Boeing 707 and Douglas DC-8 jets. Her first indoctrination flight to Frankfurt was eventful — she dumped an entire tray of cocktails into a young man's lap during turbulence. But she passed, and graduated proudly at <span class="placename" data-old="Idlewild Airport" data-new="John F. Kennedy (JFK) International Airport">Idlewild</span> (now JFK) Airport.</p>`,
